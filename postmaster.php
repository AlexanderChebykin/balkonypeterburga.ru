<?php
$EMAIL = 'super.chebyckin@yandex.ru'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'super.chebyckin@yandex.ru';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
$REPLY = 'super.chebyckin@yandex.ru';   //  e-mail для ответа 
